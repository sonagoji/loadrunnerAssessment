Register()
{
	...
	web_submit_data("register", 
		...
		"Name=FirstName", "Value=sohavuu", ENDITEM, 
		"Name=LastName", "Value=sgha", ENDITEM, 
		"Name=Email", "Value=sohavuu@gmail.com", ENDITEM, 
		"Name=Password", "Value=123456", ENDITEM, 
		"Name=ConfirmPassword", "Value=123456", ENDITEM, 
